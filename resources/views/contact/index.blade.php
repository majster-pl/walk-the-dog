                ...
                <div class="row justify-content-center">
                    <div class="col col-12 col-md-8">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <small>If you want to <span class="text-success">become an editor</span> please tick "request editor" box below and write a bit about yourself and why you want to become an editor.</small>
                            </div>
