...
@section('content')
    <div class="intro-bg-image text-black w-100 m-0 p-0">
        ...
        <div class="container py-4 text-white">
            ...
            <p class="lead">Please contribute by sharing with us<a class="link-dark fw-bold mx-1" href="{{ route('add-new-place') }}">new places</a>where you like to walk your dog :)</p>
        </div>
    </div>
